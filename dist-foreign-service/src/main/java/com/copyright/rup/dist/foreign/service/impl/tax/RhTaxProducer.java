...
/**
 * Implementation of {@link IProducer} to send usages to tax queue.
 * <p>
 ...
 */
public class RhTaxProducer implements IProducer<Usage> {
    ...
    public void send(Usage message) throws RupRuntimeException {
        try {
            ...
            throw new RupRuntimeException("Exception appeared while sending usages to tax queue", e);
        }
    }
}
