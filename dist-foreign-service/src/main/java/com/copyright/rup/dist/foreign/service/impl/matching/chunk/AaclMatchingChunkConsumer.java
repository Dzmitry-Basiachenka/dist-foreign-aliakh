 ...
 */
@Component("df.service.aaclMatchingChunkConsumer")
public class AaclMatchingChunkConsumer implements IConsumer<List<Usage>> {
    ...
    @Override
    @Profiled(tag = "AaclMatchingChunkConsumer.consume")
