 ...
 */
@Component("df.service.rhEligibilityChunkConsumer")
public class RhEligibilityChunkConsumer implements IConsumer<List<Usage>> {
    ...
    @Autowired
    @Qualifier("df.service.ntsRhEligibilityChunkProcessor")
    private IChainChunkProcessor<List<Usage>, Usage> rhEligibilityProcessor;

    @Override
    @Profiled(tag = "RhEligibilityChunkConsumer.consume")
