 ...
 */
@Component("df.service.commonUsageChunkSerializer")
public class CommonUsageChunkSerializer extends StdSerializer<List<Usage>> {

    /**
     * Constructor.
     */
    public CommonUsageChunkSerializer() {
