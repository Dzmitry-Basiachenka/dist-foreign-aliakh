...
public class AaclMatchingConsumer implements IConsumer<Usage> {
    ...
    public void consume(Usage usage) {
        if (Objects.nonNull(usage)) {
            LOGGER.trace("Consume AACL usage for matching processing. Started. UsageId={}, WrWrkInst={}",
                usage.getId(), usage.getWrWrkInst());
            workMatchingService.matchByWrWrkInst(usage);
            LOGGER.trace(
                "Consume AACL usage for matching processing. Finished. UsageId={}, WrWrkInst={}, UsageStatus={}",
