 ...
 * @author Ihar Suvorau
 */
@Component("df.service.matchingUnmarshaller")
public class MatchingUnmarshaller extends CommonMarshaller {
    ...
    protected ObjectMapper getObjectMapper() {
        ...
        simpleModule.addDeserializer(Usage.class, new MatchingDeserializer());
