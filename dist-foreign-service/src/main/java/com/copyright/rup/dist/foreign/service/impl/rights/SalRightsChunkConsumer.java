 ...
 */
@Component("df.service.salRightsChunkConsumer")
public class SalRightsChunkConsumer implements IConsumer<List<Usage>> {
    ...
    @Autowired
    @Qualifier("df.service.salRightsChunkProcessor")
    private IChainChunkProcessor<List<Usage>, Usage> salRightsProcessor;

    @Override
    @Profiled(tag = "SalRightsChunkConsumer.consume")
