 ...
 */
@Component("df.service.salMatchingChunkConsumer")
public class SalMatchingChunkConsumer implements IConsumer<List<Usage>> {
    ...
    @Override
    @Profiled(tag = "SalMatchingChunkConsumer.consume")
    @Transactional
