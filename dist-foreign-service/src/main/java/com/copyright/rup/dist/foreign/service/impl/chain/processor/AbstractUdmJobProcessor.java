 ...
 * @author Ihar Suvorau
 */
abstract class AbstractUdmJobProcessor extends AbstractChainProcessor<UdmUsage>
    ...
    public JobInfo jobProcess(String productFamily) {
        ...
        if (CollectionUtils.isNotEmpty(usageIds)) {
            ...
            LOGGER.info("Send {} usages for processing. Started. ProductFamily=ACL_UDM, UsagesCount={}", usageStatus,
                usagesCount);
