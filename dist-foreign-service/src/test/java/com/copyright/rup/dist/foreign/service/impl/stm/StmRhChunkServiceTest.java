...
/**
 * Verifies {@link StmRhChunkService}.
 * <p>
 ...
 */
public class StmRhChunkServiceTest {

    private static final String RH_ID = RupPersistUtils.generateUuid();
    private static final String NTS_PRODUCT_FAMILY = "NTS";

    private IPrmIntegrationChunkService prmIntegrationService;
    private IUsageService usageServiceMock;
    private StmRhChunkService stmRhService;

    @Before
    public void setUp() {
        prmIntegrationService = createMock(IPrmIntegrationChunkService.class);
        usageServiceMock = createMock(IUsageService.class);
        stmRhService = new StmRhChunkService();
