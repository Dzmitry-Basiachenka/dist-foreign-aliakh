...
/**
 * Verifies {@link FasRightsChunkConsumer}.
 * <p>
 ...
 */
public class FasRightsChunkConsumerTest {

    private FasRightsChunkConsumer fasRightsConsumer;
    private IChainChunkProcessor<List<Usage>, Usage> fasRightsProcessor;

    @Before
    @SuppressWarnings("unchecked")
    public void setUp() {
        fasRightsConsumer = new FasRightsChunkConsumer();
        fasRightsProcessor = createMock(IChainChunkProcessor.class);
