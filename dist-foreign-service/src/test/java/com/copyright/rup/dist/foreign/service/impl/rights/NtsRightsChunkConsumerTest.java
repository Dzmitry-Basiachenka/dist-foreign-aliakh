...
/**
 * Verifies {@link NtsRightsChunkConsumer}.
 * <p>
 ...
 */
public class NtsRightsChunkConsumerTest {

    private NtsRightsChunkConsumer ntsRightsConsumer;
    private IChainChunkProcessor<List<Usage>, Usage> ntsRightsProcessor;

    @Before
    @SuppressWarnings("unchecked")
    public void setUp() {
        ntsRightsConsumer = new NtsRightsChunkConsumer();
        ntsRightsProcessor = createMock(IChainChunkProcessor.class);
