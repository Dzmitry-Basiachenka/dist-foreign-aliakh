...
/**
 * Verifies {@link FasMatchingChunkConsumer}.
 * <p>
 ...
 */
public class FasMatchingChunkConsumerTest {
    ...
    private FasMatchingChunkConsumer consumer;
    private IChainChunkProcessor<List<Usage>, Usage> matchingProcessor;

    @Before
    public void setUp() {
        consumer = new FasMatchingChunkConsumer();
