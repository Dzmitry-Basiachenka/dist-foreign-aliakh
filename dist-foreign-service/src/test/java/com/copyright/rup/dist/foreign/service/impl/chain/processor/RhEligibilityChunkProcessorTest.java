...
/**
 * Verifies {@link RhEligibilityChunkProcessor}.
 * <p>
 ...
 */
public class RhEligibilityChunkProcessorTest {

    private RhEligibilityChunkProcessor rhEligibilityProcessor;
    private IProducer<List<Usage>> rhEligibilityProducer;

    @Before
    @SuppressWarnings("unchecked")
    public void setUp() {
        rhEligibilityProcessor = new RhEligibilityChunkProcessor();
