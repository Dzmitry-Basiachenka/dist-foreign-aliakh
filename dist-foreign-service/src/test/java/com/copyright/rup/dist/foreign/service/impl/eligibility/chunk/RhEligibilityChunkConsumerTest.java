package com.copyright.rup.dist.foreign.service.impl.eligibility.chunk;
...
/**
 * Verifies {@link RhEligibilityChunkConsumer}.
 * <p>
 ...
 */
public class RhEligibilityChunkConsumerTest {

    private static final String RH_ID = "ba54c138-398f-4444-92fb-9e3aa991ea1d";

    private RhEligibilityChunkConsumer rhEligibilityConsumer;
    private IChainChunkProcessor<List<Usage>, Usage> rhEligibilityProcessor;
    private IPrmIntegrationService prmIntegrationService;

    @Before
    @SuppressWarnings("unchecked")
    public void setUp() {
        rhEligibilityConsumer = new RhEligibilityChunkConsumer();
        rhEligibilityProcessor = createMock(IChainChunkProcessor.class);
