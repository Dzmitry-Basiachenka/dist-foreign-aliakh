...
@TestPropertySource(properties = {"test.liquibase.changelog=send-nts-to-crm-data-init.groovy"})
    ...
    public void testSendToCrm() {
        testBuilder
            ...
            .expectScenarioAudit(ImmutableMap.of(
                "67027e15-17c6-4b9b-b7f0-12ec414ad344", buildArchivedScenarioAudit()
            ))
            .build()
            .run();
    }
