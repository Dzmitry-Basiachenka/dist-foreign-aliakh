...
@Transactional
//TODO: adjust test and data to process multiple usages at a time
public class CreateNtsBatchChunkIntegrationTest {
    ...
    @Autowired
    private CreateNtsBatchChunkIntegrationTestBuilder testBuilder;
