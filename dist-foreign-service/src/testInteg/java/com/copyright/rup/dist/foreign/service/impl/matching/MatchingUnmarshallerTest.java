...
/**
 * Verifies unmarshaller matching functionality.
 * <p>
...
public class MatchingUnmarshallerTest {

    @Autowired
    @Qualifier("df.service.matchingUnmarshaller")
    private CommonUsageUnmarshaller unmarshaller;

    @Test
    public void testDeserialize() {
        try (InputStream inputStream = MatchingUnmarshallerTest.class.getResourceAsStream("matching_message.json")) {
