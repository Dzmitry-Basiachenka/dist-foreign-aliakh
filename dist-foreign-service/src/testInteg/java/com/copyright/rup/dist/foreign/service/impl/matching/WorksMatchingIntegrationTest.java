...
public class WorksMatchingIntegrationTest {
    ...
    private static final String TITLE_2 = "Solar Cells";
    private static final String TITLE_3 = "Proceedings of a symposium";
    private static final String TITLE_4 =
        "Kieckhefer, Richard, Forbidden Rites: A Necromancer's Manual of the Fifteenth Century";
    private static final String TITLE_5 = "Kieckhefer, Richard, Forbidden Rites";
    private static final String TITLE_6 = "Fall guys in the florentine flood";
    private static final String TITLE_7 = "Annuaire de la communication en Rhône-Alpes";
    ...
    public void testExecuteInternal() {
        ...
        verifyUsage("d6e01eb0-45d8-441a-81e6-9c5cf5a44b0d", null, UsageStatusEnum.WORK_NOT_FOUND, "FAS2", TITLE_5,
        ...
        verifyUsage("0949c35c-53f9-4aec-92d2-1e728235cd00", null, UsageStatusEnum.WORK_NOT_FOUND, FAS_PRODUCT_FAMILY,
            TITLE_5, null, "Wr Wrk Inst was not found by standard number ETOCRN066582498");
    ...
    private void verifyUsage(String usageId, Long wrWrkInst, UsageStatusEnum status, String productFamily,
                             String workTitle, String systemTitle, String auditMessage) {
        ...
        assertEquals(auditMessage, auditItems.get(0).getActionReason());
    }
}
