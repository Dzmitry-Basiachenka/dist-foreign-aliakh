databaseChangeLog {
    ...
    changeSet(id: '2021-10-21-00', author: 'Uladzislau Shalamitski <ushalamitski@copyright.com>') {
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_udm_value') {
            column(name: 'df_udm_value_uid', value: '89b7259e-39e0-4281-9fed-860c24932b78')
            column(name: 'period', value: 202006)
            column(name: 'status_ind', value: "RESEARCH_COMPLETE")
            column(name: 'rh_account_number', value: 1000011322)
            column(name: 'wr_wrk_inst', value: 876543211)
            column(name: 'system_title', value: 'Grishka & the Bear')
            column(name: 'standard_number', value: '978-0-200-00000-0')
            ...
            column(name: 'price_source', value: '234')
            ...
            column(name: 'content', value: 10)
            column(name: 'content_unit_price', value: 15)
            column(name: 'content_source', value: '1234')
            column(name: 'content_flag', value: 'true')
            column(name: 'record_version', value: 8)
            column(name: 'created_by_user', value: 'wjohn@copyright.com')
            column(name: 'created_datetime', value: '2021-12-26 12:00:00+00')
            column(name: 'updated_by_user', value: 'wjohn@copyright.com')
            column(name: 'updated_datetime', value: '2021-12-27 12:00:00+00')
        }

        insert(schemaName: dbAppsSchema, tableName: 'df_udm_value') {
            column(name: 'df_udm_value_uid', value: '9a2dadaa-0a8e-4930-af48-4306929d500c')
            column(name: 'period', value: 202006)
            column(name: 'status_ind', value: "RESEARCH_COMPLETE")
            column(name: 'rh_account_number', value: 1000011322)
            column(name: 'wr_wrk_inst', value: 876543212)
            column(name: 'system_title', value: 'Grishka & the Bear')
            column(name: 'standard_number', value: '978-0-200-00000-0')
            column(name: 'publication_type_uid', value: '73876e58-2e87-485e-b6f3-7e23792dd214')
            column(name: 'assignee', value: 'jjohn@copyright.com')
            column(name: 'price', value: 0)
            column(name: 'price_in_usd', value: 0)
            column(name: 'price_type', value: 'Individual')
            column(name: 'price_access_type', value: 'Digital')
            column(name: 'price_source', value: '234')
            column(name: 'price_flag', value: 'true')
            ...
            column(name: 'content_unit_price', value: 0)
            column(name: 'content_source', value: '1234')
            column(name: 'content_flag', value: 'true')
            column(name: 'record_version', value: 8)
            column(name: 'created_by_user', value: 'wjohn@copyright.com')
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_udm_value') {
            column(name: 'df_udm_value_uid', value: 'ec33affb-a120-493f-8f7a-e2934aee74e9')
            column(name: 'period', value: 202006)
            column(name: 'status_ind', value: "RESEARCH_COMPLETE")
            column(name: 'rh_account_number', value: 1000011322)
            column(name: 'wr_wrk_inst', value: 876543213)
            column(name: 'system_title', value: 'Grishka & the Bear')
            column(name: 'standard_number', value: '978-0-200-00000-0')
            column(name: 'publication_type_uid', value: '73876e58-2e87-485e-b6f3-7e23792dd214')
            column(name: 'assignee', value: 'jjohn@copyright.com')
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_udm_usage') {
            column(name: 'df_udm_usage_uid', value: '6bfd9398-7898-45a9-a575-a0d222ed4ab1')
            column(name: 'df_udm_usage_batch_uid', value: 'a0405f18-b5c9-43a0-a877-d064117e08a6')
            column(name: 'original_detail_id', value: 'OGN654GHASG007')
            column(name: 'period', value: '202006')
            column(name: 'period_end_date', value: '2016-12-31')
            column(name: 'status_ind', value: 'ELIGIBLE')
            column(name: 'rh_account_number', value: 1000000322)
            column(name: 'wr_wrk_inst', value: 876543211)
            column(name: 'reported_title', value: 'Grishka & the Bear')
            column(name: 'system_title', value: 'Grishka & the Bear')
            column(name: 'reported_standard_number', value: '978-0-200-00000-0')
            column(name: 'standard_number', value: '978-0-200-00000-0')
            column(name: 'reported_pub_type', value: 'Book')
            column(name: 'publication_format', value: 'Digital')
            column(name: 'article', value: 'Tenside, surfactants, detergents')
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_udm_usage') {
            column(name: 'df_udm_usage_uid', value: 'facc3fc1-7c56-47bc-a479-0ab74e4fe2fc')
            column(name: 'df_udm_usage_batch_uid', value: 'a0405f18-b5c9-43a0-a877-d064117e08a6')
            column(name: 'original_detail_id', value: 'OGN654GHASG008')
            column(name: 'period', value: '202006')
            column(name: 'period_end_date', value: '2016-12-31')
            column(name: 'status_ind', value: 'ELIGIBLE')
            column(name: 'rh_account_number', value: 1000000322)
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_udm_usage') {
            column(name: 'df_udm_usage_uid', value: 'ed698c67-c502-4363-ad44-f579416bc15c')
            column(name: 'df_udm_usage_batch_uid', value: 'a0405f18-b5c9-43a0-a877-d064117e08a6')
            column(name: 'original_detail_id', value: 'OGN654GHASG009')
            column(name: 'period', value: '202006')
            column(name: 'period_end_date', value: '2016-12-31')
            column(name: 'status_ind', value: 'ELIGIBLE')
            column(name: 'rh_account_number', value: 1000000322)
