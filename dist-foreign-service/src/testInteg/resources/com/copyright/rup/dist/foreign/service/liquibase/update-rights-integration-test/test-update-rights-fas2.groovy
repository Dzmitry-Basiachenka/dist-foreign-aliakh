databaseChangeLog {
    ...
    changeSet(id: '2023-07-10-01', author: 'Aliaksandr Liakh <aliakh@copyright.com>') {
        comment('Insert test data for testUpdateRightsProductFamilyFas2GrantProductFamilyFas')
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_usage_batch') {
            column(name: 'df_usage_batch_uid', value: '0fb8e785-4e5f-473b-8a41-b490c4ef4c89')
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_usage') {
            column(name: 'df_usage_uid', value: '286b6f99-61dc-4aec-8921-1bb12a1af95c')
            column(name: 'df_usage_batch_uid', value: '0fb8e785-4e5f-473b-8a41-b490c4ef4c89')
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_usage') {
            column(name: 'df_usage_uid', value: '439b553b-3df4-4b1d-b5c4-43e383614e2e')
            column(name: 'df_usage_batch_uid', value: '0fb8e785-4e5f-473b-8a41-b490c4ef4c89')
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_usage_fas') {
            column(name: 'df_usage_fas_uid', value: '439b553b-3df4-4b1d-b5c4-43e383614e2e')
            column(name: 'market', value: 'Univ')
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_usage') {
            column(name: 'df_usage_uid', value: '6535b989-a9ee-4089-b815-1fee4c130e0b')
            column(name: 'df_usage_batch_uid', value: '0fb8e785-4e5f-473b-8a41-b490c4ef4c89')
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_usage_fas') {
            column(name: 'df_usage_fas_uid', value: '6535b989-a9ee-4089-b815-1fee4c130e0b')
            column(name: 'market', value: 'Univ')
            column(name: 'market_period_from', value: 2015)
            column(name: 'market_period_to', value: 2015)
            column(name: 'reported_value', value: 100.00)
