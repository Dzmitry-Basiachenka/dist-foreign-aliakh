...
public class AggregateLicenseeClassMappingWindowTest {
    ...
    public void testSaveButtonClickListener() {
        ...
        var buttonsLayout = getFooterLayout(mappingWindow);
    ...
    public void testDefaultButtonClickListener() {
        var buttonsLayout = getFooterLayout(window);
        var defaultButton = (Button) buttonsLayout.getComponentAt(3);
        defaultButton.click();
    ...
    public void testSetAppliedParameters() {
        var mappingWindow = new AggregateLicenseeClassMappingWindow(false);
        mappingWindow.setAppliedParameters(appliedParams);
        ...
        Grid grid = (Grid) ((VerticalLayout) getDialogContent(mappingWindow)).getComponentAt(0);
