...
public class CommonAppliedFilterPanelTest {
    ...
    public void testCreateLabelWithSingleValue() {
        expectedLabel.add(new Html("<li><b><i>Status: </i></b>ELIGIBLE</li>"));
        assertNull(
    ...
    public void testCreateLabelWithMultipleValues() {
        expectedLabel.add(new Html("<li><b><i>Assignees: </i></b>user@copyright.com, john@copyright.com</li>"));
    ...
    public void testCreateLabelWithOperator() {
        expectedLabel.add(new Html("<div><li><b><i>Annual Multiplier From: </i></b>50</li>" +
            "<li><b><i>Annual Multiplier To: </i></b>100</li>" +
            "<li><b><i>Operator: </i></b>BETWEEN</li></div>"));
    ...
    private void verifyLabel(Label actualLabel) {
        Html expectedHtml = (Html) expectedLabel.getChildren().findFirst().orElseThrow();
        Html actualHtml = (Html) actualLabel.getChildren().findFirst().orElseThrow();
        assertEquals(expectedHtml.getInnerHtml(), actualHtml.getInnerHtml());
    }
}
