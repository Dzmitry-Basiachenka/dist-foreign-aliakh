...
public class UdmPriceTypeRepositoryIntegrationTest {
    ...
    public void testFindAllPriceTypes() {
        List<String> expectedPriceTypes = List.of("Individual", "Institution", "Corporate Tiered pricing", "List Price",
            "Open Access", "Free to Qualified", "Cost of Membership", "Per-Article price", "Other (Add to Price Note)");
    ...
    public void testFindAllAccessPriceTypes() {
        List<String> expectedPriceAccessTypes = List.of("Print", "Digital", "Combined - only option");
