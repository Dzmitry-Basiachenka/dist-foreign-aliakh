databaseChangeLog {
    ...
    changeSet(id: '2022-02-11-01', author: 'Dzmitry Basiachenka <dbasiachenka@copyright.com>') {
        comment('Inserts data for testWriteScenarioUsagesCsvReport')
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_usage_batch') {
            ...
            column(name: 'name', value: 'FAS Batch 1 for Write Scenario Usages Csv Report test')
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_usage_batch') {
            ...
            column(name: 'name', value: 'FAS Batch 2 for Write Scenario Usages Csv Report test')
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_scenario') {
            column(name: 'df_scenario_uid', value: 'a72a3512-082e-46a0-b2b9-67763e30e7fc')
            column(name: 'name', value: 'FAS Scenario for Write Scenario Usages Csv Report test')
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_usage_fas') {
            ...
            column(name: 'reported_standard_number', value: '10.1007/978-3-642-16327-2_29')
        }
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_usage_fas') {
            ...
            column(name: 'reported_standard_number', value: '012345XX-79049')
        }
