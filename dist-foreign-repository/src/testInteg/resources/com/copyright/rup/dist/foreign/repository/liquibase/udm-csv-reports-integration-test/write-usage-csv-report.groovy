databaseChangeLog {
    ...
    changeSet(id: '2021-07-05-00', author: 'Dzmitry Basiachenka <dbasiachenka@copyright.com>') {
        comment('Insert test data for testWriteUsageCsvReportSpecialistManager, testWriteUsageEmptyCsvReportSpecialistManager, ' +
                'testWriteUsageCsvReportResearcher, testWriteUsageEmptyCsvReportResearcher, testWriteUsageCsvReportView, ' +
                'testWriteUsageEmptyCsvReportView')
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_udm_usage') {
            ...
            column(name: 'annualized_copies', value: 300.10000)
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_udm_usage') {
            ...
            column(name: 'annualized_copies', value: 4.00001)
            column(name: 'statistical_multiplier', value: 1.01234)
            column(name: 'quantity', value: 3)
            column(name: 'annual_multiplier', value: 12)
            column(name: 'created_by_user', value: 'user@copyright.com')
            column(name: 'updated_by_user', value: 'user@copyright.com')
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_udm_usage') {
            ...
            column(name: 'annual_multiplier', value: 12)
            column(name: 'statistical_multiplier', value: 1.00123)
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_udm_usage') {
            ...
            column(name: 'type_of_use', value: 'PRINT')
            column(name: 'reported_type_of_use', value: 'PRINT_COPIES')
            column(name: 'annualized_copies', value: 4.00000)
            column(name: 'statistical_multiplier', value: 1.00000)
            column(name: 'quantity', value: 3)
            column(name: 'annual_multiplier', value: 12)
            column(name: 'created_by_user', value: 'user@copyright.com')
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_udm_usage') {
            ...
            column(name: 'annualized_copies', value: 4.01234)
            column(name: 'statistical_multiplier', value: 1.00001)
            column(name: 'quantity', value: 3)
            column(name: 'annual_multiplier', value: 6)
            column(name: 'created_by_user', value: 'user@copyright.com')
            column(name: 'updated_by_user', value: 'user@copyright.com')
