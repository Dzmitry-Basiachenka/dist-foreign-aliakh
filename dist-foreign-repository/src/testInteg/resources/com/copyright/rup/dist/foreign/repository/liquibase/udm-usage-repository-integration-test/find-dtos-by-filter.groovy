databaseChangeLog {
    ...
    changeSet(id: '2021-06-15-00', author: 'Uladzislau Shalamitski <ushalamitski@copyright.com>') {
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_udm_usage') {
            ...
            column(name: 'reported_title', value: 'Working in Asia')
            column(name: 'system_title', value: 'Working in Asia')
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_udm_usage') {
            ...
            column(name: 'reported_title', value: 'Economics of strategy')
            column(name: 'system_title', value: 'Economics of strategy')
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_udm_usage') {
            ...
            column(name: 'reported_title', value: 'Team building')
            column(name: 'system_title', value: 'Team building')
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_udm_usage') {
            ...
            column(name: 'survey_respondent', value: 'c6615155-f82b-402c-8f22-77e2722ae448')
            column(name: 'ip_address', value: 'ip192.168.211.211')
            column(name: 'survey_country', value: 'Germany !@#$%^&*()_+-=?/\\\'"}{][<>')
