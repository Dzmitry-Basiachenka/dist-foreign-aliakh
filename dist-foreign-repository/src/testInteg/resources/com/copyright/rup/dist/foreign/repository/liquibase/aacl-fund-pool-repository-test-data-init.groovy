databaseChangeLog {
    ...
    changeSet(id: '2020-02-05-00', author: 'Aliaksandr Liakh <aliakh@copyright.com>') {
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_fund_pool_detail_aacl') {
            column(name: 'df_fund_pool_detail_aacl_uid', value: '3fa67238-bf22-4daa-9307-8b8d8c51347e')
            column(name: 'df_fund_pool_aacl_uid', value: '5376a3c0-23df-41f9-b2fb-21de6d2fb707')
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_fund_pool_detail_aacl') {
            column(name: 'df_fund_pool_detail_aacl_uid', value: '8284e213-99f0-48cc-a0f2-7880c64a5d09')
            column(name: 'df_fund_pool_aacl_uid', value: '5376a3c0-23df-41f9-b2fb-21de6d2fb707')
    ...
    changeSet(id: '2020-02-06-00', author: 'Stanislau Rudak <srudak@copyright.com>') {
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_fund_pool_aacl') {
            column(name: 'df_fund_pool_aacl_uid', value: 'ce9c1258-6d29-4224-a4e6-6f03b6aeef53')
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_fund_pool_aacl') {
            column(name: 'df_fund_pool_aacl_uid', value: '100ce91c-49c1-4197-9f7a-23a8210d5706')
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_fund_pool_detail_aacl') {
            column(name: 'df_fund_pool_detail_aacl_uid', value: '44709581-fb7e-4d72-9427-dd5681f24fc5')
            column(name: 'df_fund_pool_aacl_uid', value: 'ce9c1258-6d29-4224-a4e6-6f03b6aeef53')
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_fund_pool_detail_aacl') {
            column(name: 'df_fund_pool_detail_aacl_uid', value: 'a6a2c928-297d-4584-9fb6-abf41c84e5e4')
            column(name: 'df_fund_pool_aacl_uid', value: 'ce9c1258-6d29-4224-a4e6-6f03b6aeef53')
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_fund_pool_detail_aacl') {
            column(name: 'df_fund_pool_detail_aacl_uid', value: '50216473-2713-4b52-b40f-dfc2d2aef755')
            column(name: 'df_fund_pool_aacl_uid', value: '100ce91c-49c1-4197-9f7a-23a8210d5706')
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_fund_pool_detail_aacl') {
            column(name: 'df_fund_pool_detail_aacl_uid', value: '4ff44b56-6b2f-4b00-8989-9bbc23796254')
            column(name: 'df_fund_pool_aacl_uid', value: '100ce91c-49c1-4197-9f7a-23a8210d5706')
