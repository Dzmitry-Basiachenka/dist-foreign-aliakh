databaseChangeLog {
    ...
    changeSet(id: '2020-01-28-00', author: 'Aliaksandr Liakh <aliakh@copyright.com>') {
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_usage_batch') {
            ...
            column(name: 'fund_pool', value: '{"non_stm_minimum_amount":7,"stm_amount":700,"stm_minimum_amount":50,"non_stm_amount":5000,"fund_pool_period_from":2015,"markets":["Edu","Gov"],"fund_pool_period_to":2016}')
        }
