databaseChangeLog {
    ...
    changeSet(id: '2021-07-02-01', author: 'Uladzislau Shalamitski <ushalamitski@copyright.com>') {
        comment('Inserting test data for testUpdateAssignee')

        insert(schemaName: dbAppsSchema, tableName: 'df_udm_usage_batch') {
            column(name: 'df_udm_usage_batch_uid', value: '201e64f9-b319-4543-9450-d289e0edd90d')
            column(name: 'name', value: 'UDM Batch 2020 to test assignee update')
            column(name: 'period', value: 202006)
            column(name: 'usage_origin', value: 'RFA')
            column(name: 'channel', value: 'Rightsdirect')
        }
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_udm_usage') {
            column(name: 'df_udm_usage_uid', value: 'd247235f-3595-4b74-b091-f6f91fba2e7d')
            column(name: 'df_udm_usage_batch_uid', value: '201e64f9-b319-4543-9450-d289e0edd90d')
    ...
    changeSet(id: '2021-09-02-00', author: 'Anton Azarenka <aazarenka@copyright.com>') {
        comment('Inserting test data for testPublishToBaseline')

        //Batch for publish to baseline
        insert(schemaName: dbAppsSchema, tableName: 'df_udm_usage_batch') {
