databaseChangeLog {
    ...
    changeSet(id: '2019-06-24-00', author: 'Ihar Suvorau <isuvorau@copyright.com>') {
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_usage_archive') {
            ...
            column(name: 'df_usage_batch_uid', value: '1a615c47-531a-4a27-a4f3-a5bd3d5a4b1c')
            column(name: 'df_fund_pool_uid', value: 'a40132c0-d724-4450-81d2-456e67ff6f64') // B-55836 remove
            column(name: 'work_title', value: '2001 IEEE Workshop on High Performance Switching and Routing, 29-31 May 2001, Dallas, Texas, USA')
            ...
            column(name: 'author', value: 'Íñigo López de Mendoza, marqués de Santillana') // B-55836 remove
            column(name: 'number_of_copies', value: '25')
            column(name: 'reported_value', value: '99') // B-55836 remove
            column(name: 'gross_amount', value: '99.00')
        }
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_usage_archive') {
            ...
            column(name: 'reported_value', value: '150') // B-55836 remove
            column(name: 'gross_amount', value: '150.00')
