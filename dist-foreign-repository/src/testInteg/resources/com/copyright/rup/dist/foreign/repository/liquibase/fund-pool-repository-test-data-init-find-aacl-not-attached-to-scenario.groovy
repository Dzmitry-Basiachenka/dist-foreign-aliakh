databaseChangeLog {
    ...
    changeSet(id: '2020-04-22-00', author: 'Stanislau Rudak <srudak@copyright.com>') {
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_fund_pool') {
            ...
            column(name: 'created_datetime', value: '2020-01-03 01:00:00-04')
            column(name: 'created_by_user', value: 'coordinator@copyright.com')
            column(name: 'updated_datetime', value: '2020-01-03 01:00:00-04')
        }
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_fund_pool') {
            ...
            column(name: 'created_datetime', value: '2020-01-03 01:00:00-04')
            column(name: 'created_by_user', value: 'coordinator@copyright.com')
            column(name: 'updated_datetime', value: '2020-01-03 02:00:00-04')
        }
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_fund_pool') {
            ...
            column(name: 'created_datetime', value: '2020-01-03 01:00:00-04')
            column(name: 'created_by_user', value: 'coordinator@copyright.com')
            column(name: 'updated_datetime', value: '2020-01-03 03:00:00-04')
        }
