databaseChangeLog {
    ...
    changeSet(id: '2021-09-27-01', author: 'Azarenka Anton <aazarenka@copyright.com>') {
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_udm_value') {
            ...
            column(name: 'price_year', value: 2021)
            column(name: 'price_type', value: 'price type')
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_udm_value') {
            ...
            column(name: 'wr_wrk_inst', value: 306985859)
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_udm_value') {
            ...
            column(name: 'price_access_type', value: 'access type 2')
            column(name: 'price_type', value: 'price type 2')
    ...
    changeSet(id: '2021-09-28-00', author: 'Dzmitry Basiachenka <dbasiachenka@copyright.com>') {
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_udm_value') {
            column(name: 'df_udm_value_uid', value: '66cc734f-68b6-4baa-8fa9-2a9199cbacef')
            column(name: 'period', value: 202106)
            column(name: 'status_ind', value: 'PRELIM_RESEARCH_COMPLETE')
            column(name: 'rh_account_number', value: 1000002222)
            column(name: 'wr_wrk_inst', value: 123456789)
