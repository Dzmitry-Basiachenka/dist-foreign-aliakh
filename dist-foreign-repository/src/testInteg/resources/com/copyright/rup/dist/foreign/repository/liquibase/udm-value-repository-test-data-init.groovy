databaseChangeLog {
    ...
    changeSet(id: '2021-09-23-01', author: 'Azarenka Anton <aazarenka@copyright.com>') {
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_udm_value') {
            ...
            column(name: 'rh_account_number', value: 1000002222)
    ...
    changeSet(id: '2021-09-28-00', author: 'Dzmitry Basiachenka <dbasiachenka@copyright.com>') {
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_udm_value') {
            ...
            column(name: 'standard_number', value: '1873-7773')
            column(name: 'standard_number_type', value: 'TFWRKINST')
            column(name: 'publication_type_uid', value: '076f2c40-f524-405d-967a-3840df2b57df')
            column(name: 'price', value: 5.0000000000)
            column(name: 'price_in_usd', value: 5.0000000000)
            column(name: 'price_year', value: 2021)
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_udm_value') {
            ...
            column(name: 'standard_number', value: '1873-5555')
            column(name: 'standard_number_type', value: 'VALISSN13')
            column(name: 'assignee', value: 'jjohn@copyright.com')
            column(name: 'price', value: 10.0000000000)
            column(name: 'price_in_usd', value: 5.0000000000)
            column(name: 'price_year', value: 2021)
    ...
    changeSet(id: '2021-10-15-00', author: 'Uladzislau Shalamitski <ushalamitski@copyright.com>') {
        comment('Inserts test data for testPublishToBaseline')
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_udm_value_baseline') {
            column(name: 'df_udm_value_baseline_uid', value: '2e07c041-79e8-48e5-a875-229d5e0f5259')
            column(name: 'period', value: 211112)
            column(name: 'wr_wrk_inst', value: 569856369)
            column(name: 'system_title', value: 'Malcolm Gruel Jr')
            column(name: 'price', value: 60)
