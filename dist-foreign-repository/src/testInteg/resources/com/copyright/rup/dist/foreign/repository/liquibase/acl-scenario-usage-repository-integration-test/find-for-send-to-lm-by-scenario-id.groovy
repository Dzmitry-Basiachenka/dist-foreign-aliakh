databaseChangeLog {
    ...
    changeSet(id: '2022-11-01-00', author: 'Anton Azarenka <aazarenka@copyright.com>') {
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_acl_scenario_detail') {
            column(name: 'df_acl_scenario_detail_uid', value: '22667984-9bce-4012-8078-6044979a8c5d')
            column(name: 'df_acl_scenario_uid', value: '3ac016af-eb68-41b0-a031-7477e623a443')
            column(name: 'period_end_date', value: 202212)
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_acl_scenario_detail') {
            column(name: 'df_acl_scenario_detail_uid', value: 'ca2438e7-6577-4dfc-9032-bae6794125a9')
            column(name: 'df_acl_scenario_uid', value: '3ac016af-eb68-41b0-a031-7477e623a443')
