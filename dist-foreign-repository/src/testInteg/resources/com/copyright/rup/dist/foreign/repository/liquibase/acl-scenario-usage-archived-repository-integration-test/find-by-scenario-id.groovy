databaseChangeLog {
    ...
    changeSet(id: '2022-10-31-00', author: 'Anton Azarenka <aazarenka@copyright.com>') {
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_acl_scenario_detail_archived') {
            column(name: 'df_acl_scenario_detail_archived_uid', value: '0451320c-60b6-4570-b6d3-12e82f62f21c')
            column(name: 'df_acl_scenario_uid', value: '326d59f3-bdea-4579-9100-63d0e76386fe')
            column(name: 'period_end_date', value: 202212)
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_acl_scenario_detail_archived') {
            column(name: 'df_acl_scenario_detail_archived_uid', value: 'a5c179d5-7f49-4b12-b006-4ebb088238a4')
            column(name: 'df_acl_scenario_uid', value: '326d59f3-bdea-4579-9100-63d0e76386fe')
