databaseChangeLog {
    ...
    changeSet(id: '2023-08-03-00', author: 'Aliaksandr Liakh <aliakh@copyright.com>') {
        comment('Insert test data for testWriteBaselineValuesCsvReport, testWriteBaselineValuesEmptyCsvReport')

        insert(schemaName: dbAppsSchema, tableName: 'df_udm_value') {
            column(name: 'df_udm_value_uid', value: '83598ea4-174f-4467-9a4b-7b4aebc19515')
            ...
            column(name: 'updated_datetime', value: '2021-09-10T00:00:00-04:00')
            column(name: 'updated_by_user', value: 'user@copyright.com')
            column(name: 'created_datetime', value: '2021-09-10T00:00:00-04:00')
            column(name: 'created_by_user', value: 'user@copyright.com')
        }

        insert(schemaName: dbAppsSchema, tableName: 'df_udm_value') {
            column(name: 'df_udm_value_uid', value: '9c2f820e-6b9c-4c01-b2a8-052aca26c0bd')
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_udm_value') {
            column(name: 'df_udm_value_uid', value: '6281d564-d709-46ce-af39-014dc8fb50d8')
            ...
            column(name: 'updated_by_user', value: 'user@copyright.com')
            column(name: 'created_datetime', value: '2021-09-12T00:00:00-04:00')
            column(name: 'created_by_user', value: 'user@copyright.com')
        }

        insert(schemaName: dbAppsSchema, tableName: 'df_udm_value_baseline') {
            column(name: 'df_udm_value_baseline_uid', value: '83598ea4-174f-4467-9a4b-7b4aebc19515')
            column(name: 'period', value: 211212)
            column(name: 'wr_wrk_inst', value: 273337156)
            column(name: 'price_flag', value: false)
            column(name: 'content_flag', value: false)
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_udm_value_baseline') {
            column(name: 'df_udm_value_baseline_uid', value: '9c2f820e-6b9c-4c01-b2a8-052aca26c0bd')
            column(name: 'period', value: 211112)
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_udm_value_baseline') {
            column(name: 'df_udm_value_baseline_uid', value: '6281d564-d709-46ce-af39-014dc8fb50d8')
            column(name: 'period', value: 211112)
            column(name: 'wr_wrk_inst', value: 823333789)
