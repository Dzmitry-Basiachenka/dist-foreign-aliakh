databaseChangeLog {
    ...
    changeSet(id: '2020-12-01-00', author: 'Aliaksandr Liakh <aliakh@copyright.com>') {
        comment("Insert test data for testFindSalLicensees")
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_usage_batch') {
            ...
            column(name: 'product_family', value: 'SAL')
            column(name: 'fiscal_year', value: '2019')
            column(name: 'sal_fields', value: '{"licensee_account_number": 1112, "licensee_name": "Coors Brewing Company"}')
        }
