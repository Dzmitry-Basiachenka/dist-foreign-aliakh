databaseChangeLog {
    ...
    changeSet(id: '2020-11-05-00', author: 'Dzmitry Basiachenka <dbasiachenka@copyright.com>') {
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_fund_pool') {
            ...
            column(name: 'total_amount', value: '100.00')
            column(name: 'sal_fields', value: '{"service_fee": 0.25000, "date_received": "10/15/2015"}')
        }
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_fund_pool') {
            ...
            column(name: 'total_amount', value: '100.00')
            column(name: 'sal_fields', value: '{"service_fee": 0.25000, "date_received": "05/20/2016"}')
        }

        insert(schemaName: dbAppsSchema, tableName: 'df_usage_batch') {
            column(name: 'df_usage_batch_uid', value: 'b309b1fa-d1f5-4278-bd9b-76e09b83c2ba')
            column(name: 'name', value: 'SAL Usage Batch for testSalUndistributedLiabilitiesCsvReport')
            column(name: 'payment_date', value: '2020-06-30')
            column(name: 'product_family', value: 'SAL')
        }
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_scenario') {
            ...
            column(name: 'name', value: 'SAL Scenario 1 For testSalUndistributedLiabilitiesCsvReport')
            column(name: 'status_ind', value: 'IN_PROGRESS')
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_fund_pool') {
            ...
            column(name: 'total_amount', value: '100.00')
            column(name: 'sal_fields', value: '{"service_fee": 0.25000, "date_received": "10/17/2017"}')
        }
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_fund_pool') {
            ...
            column(name: 'total_amount', value: '100.00')
            column(name: 'sal_fields', value: '{"service_fee": 0.25000, "date_received": "10/29/2018"}')
        }
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_fund_pool') {
            ...
            column(name: 'total_amount', value: '200.00')
            column(name: 'sal_fields', value: '{"service_fee": 0.25000, "date_received": "11/10/2019"}')
        }
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_fund_pool') {
            column(name: 'df_fund_pool_uid', value: '2dc8d824-ac28-4920-9772-510f4cc51390')
            column(name: 'product_family', value: 'SAL')
            column(name: 'name', value: 'SAL Fund Pool Name 6 for testSalUndistributedLiabilitiesCsvReport')
            column(name: 'total_amount', value: '200.00')
            column(name: 'sal_fields', value: '{"service_fee": 0.25000, "date_received": "12/22/2020"}')
        }
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_scenario') {
            ...
            column(name: 'status_ind', value: 'PAID')
            column(name: 'sal_fields', value: '{"fund_pool_uid": "2dc8d824-ac28-4920-9772-510f4cc51390"}')
            column(name: 'description', value: 'SAL Scenario Description')
        }
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_usage_sal') {
            column(name: 'df_usage_sal_uid', value: '9d381f57-3245-4d41-97fb-c89e74990a23')
            column(name: 'detail_type', value: 'IB')
            column(name: 'grade', value: '5')
            column(name: 'grade_group', value: 'ITEM_BANK')
            column(name: 'assessment_name', value: 'FY16 AIR')
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_usage_archive') {
            column(name: 'df_usage_archive_uid', value: '90ad0fd5-ee35-4ed5-9e93-cf0140d7d625')
            column(name: 'df_usage_batch_uid', value: 'a75ac322-960d-4197-8e04-a72a0b87af2f')
            column(name: 'df_scenario_uid', value: 'e008c833-a51b-4862-803f-048950d0fb59')
            column(name: 'wr_wrk_inst', value: '269040891')
            column(name: 'work_title', value: 'Snap to grid')
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_usage_sal') {
            column(name: 'df_usage_sal_uid', value: '90ad0fd5-ee35-4ed5-9e93-cf0140d7d625')
            column(name: 'detail_type', value: 'UD')
            column(name: 'grade', value: '5')
            column(name: 'grade_group', value: 'GRADEK_5')
            column(name: 'assessment_name', value: 'FY16 AIR')
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_fund_pool') {
            ...
            column(name: 'product_family', value: 'SAL')
            column(name: 'name', value: 'SAL Fund Pool Name 7 for testSalUndistributedLiabilitiesCsvReport')
            column(name: 'total_amount', value: '200.00')
            column(name: 'sal_fields', value: '{"service_fee": 0.25000, "date_received": "12/30/2020"}')
        }
