databaseChangeLog {
    ...
    changeSet(id: '2022-04-21-00', author: 'Dzmitry Basiachenka <dbasiachenka@copyright.com>') {
        comment('Inserting test data for testFindPeriods')

        insert(schemaName: dbAppsSchema, tableName: 'df_acl_usage_batch') {
            column(name: 'df_acl_usage_batch_uid', value: '8c51bbc2-47b7-481d-a001-1c9a25a12a73')
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_acl_usage') {
            column(name: 'df_acl_usage_uid', value: 'f6a9340b-2b97-4479-aa2a-c3734314e75e')
            column(name: 'df_acl_usage_batch_uid', value: '8c51bbc2-47b7-481d-a001-1c9a25a12a73')
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_acl_usage_batch') {
            column(name: 'df_acl_usage_batch_uid', value: '60903e5a-ea6f-4dc7-857c-eef446034d07')
