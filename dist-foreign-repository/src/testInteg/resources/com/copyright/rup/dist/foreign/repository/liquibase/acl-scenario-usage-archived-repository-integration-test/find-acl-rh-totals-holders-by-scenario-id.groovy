databaseChangeLog {
    ...
    changeSet(id: '2022-11-03-00', author: 'Anton Azarenka <aazarenka@copyright.com>') {
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_acl_scenario_detail_archived') {
            column(name: 'df_acl_scenario_detail_archived_uid', value: '79c6196c-6d52-4ed5-8251-d653afa89aee')
            column(name: 'df_acl_scenario_uid', value: '0d0041a3-833e-463e-8ad4-f28461dc961d')
            column(name: 'period_end_date', value: 202212)
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_acl_share_detail_archived') {
            column(name: 'df_acl_share_detail_archived_uid', value: 'a5a30e94-6e8b-42bb-bd8e-37adb19741d2')
            column(name: 'df_acl_scenario_uid', value: '0d0041a3-833e-463e-8ad4-f28461dc961d')
            column(name: 'df_acl_scenario_detail_archived_uid', value: '79c6196c-6d52-4ed5-8251-d653afa89aee')
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_acl_share_detail_archived') {
            column(name: 'df_acl_share_detail_archived_uid', value: '86314fa2-4dd7-44d7-b75b-76358a599085')
            column(name: 'df_acl_scenario_uid', value: '0d0041a3-833e-463e-8ad4-f28461dc961d')
            column(name: 'df_acl_scenario_detail_archived_uid', value: '79c6196c-6d52-4ed5-8251-d653afa89aee')
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_acl_scenario_detail_archived') {
            column(name: 'df_acl_scenario_detail_archived_uid', value: '66845e1f-5603-4101-811d-29e4187a5976')
            column(name: 'df_acl_scenario_uid', value: '0d0041a3-833e-463e-8ad4-f28461dc961d')
            column(name: 'period_end_date', value: 202212)
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_acl_share_detail_archived') {
            column(name: 'df_acl_share_detail_archived_uid', value: '566da0b0-b0d6-4232-b7c2-00fce2305898')
            column(name: 'df_acl_scenario_uid', value: '0d0041a3-833e-463e-8ad4-f28461dc961d')
            column(name: 'df_acl_scenario_detail_archived_uid', value: '66845e1f-5603-4101-811d-29e4187a5976')
            column(name: 'type_of_use', value: 'PRINT')
            column(name: 'rh_account_number', value: 1000002859)
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_acl_share_detail_archived') {
            column(name: 'df_acl_share_detail_archived_uid', value: '5493dd97-9967-4647-8ca3-759e9a83bad6')
            column(name: 'df_acl_scenario_uid', value: '0d0041a3-833e-463e-8ad4-f28461dc961d')
            column(name: 'df_acl_scenario_detail_archived_uid', value: '66845e1f-5603-4101-811d-29e4187a5976')
            column(name: 'type_of_use', value: 'DIGITAL')
            column(name: 'rh_account_number', value: 1000002859)
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_acl_scenario_detail_archived') {
            column(name: 'df_acl_scenario_detail_archived_uid', value: 'a1c9054b-4716-4fdb-a9c7-8abc79347f35')
            column(name: 'df_acl_scenario_uid', value: '0d0041a3-833e-463e-8ad4-f28461dc961d')
            column(name: 'period_end_date', value: 202212)
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_acl_share_detail_archived') {
            column(name: 'df_acl_share_detail_archived_uid', value: 'b2ee2225-3436-4098-9e29-9cd861fb44f4')
            column(name: 'df_acl_scenario_uid', value: '0d0041a3-833e-463e-8ad4-f28461dc961d')
            column(name: 'df_acl_scenario_detail_archived_uid', value: 'a1c9054b-4716-4fdb-a9c7-8abc79347f35')
            column(name: 'type_of_use', value: 'PRINT')
            column(name: 'rh_account_number', value: 1000002859)
