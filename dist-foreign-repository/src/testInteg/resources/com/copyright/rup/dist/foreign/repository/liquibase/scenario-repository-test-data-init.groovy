databaseChangeLog {
    ...
    changeSet(id: '2020-09-24-00', author: 'Aliaksandr Liakh <aliakh@copyright.com>') {
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_fund_pool') {
            ...
            //TODO {aliakh} enable when processing of the df_fund_pool.sal_fields column is implemented
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_scenario') {
            ...
            column(name: 'status_ind', value: 'IN_PROGRESS')
            //TODO {aliakh} enable when processing of the df_scenario.sal_fields column is implemented
