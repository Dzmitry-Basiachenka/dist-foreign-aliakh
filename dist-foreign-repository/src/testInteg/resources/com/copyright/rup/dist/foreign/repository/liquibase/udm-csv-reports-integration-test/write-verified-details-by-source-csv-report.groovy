databaseChangeLog {
    ...
    changeSet(id: '2022-01-06-00', author: 'Mikita Maistrenka <mmaistrenka@copyright.com>') {
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_udm_usage') {
            column(name: 'df_udm_usage_uid', value: 'a17a50f9-383a-43fe-88db-988310e8211d')
            column(name: 'df_udm_usage_batch_uid', value: '590a99fb-b75f-402d-bf97-aae17512efd7')
            column(name: 'original_detail_id', value: 'OGN674GHHSB55645')
            column(name: 'period', value: 202006)
            column(name: 'period_end_date', value: '2020-06-30')
            column(name: 'status_ind', value: 'ELIGIBLE')
            column(name: 'rh_account_number', value: 1000002854)
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_udm_usage') {
            column(name: 'df_udm_usage_uid', value: 'cae99ad1-3028-49f3-b6b3-06a10e23814c')
            column(name: 'df_udm_usage_batch_uid', value: '590a99fb-b75f-402d-bf97-aae17512efd7')
            column(name: 'original_detail_id', value: 'OGN674GHHSB12345678')
            column(name: 'period', value: 202006)
            column(name: 'period_end_date', value: '2020-06-30')
            column(name: 'status_ind', value: 'ELIGIBLE')
            column(name: 'rh_account_number', value: 1000002854)
            ...
            column(name: 'annualized_copies', value: 2)
            column(name: 'is_baseline_flag', value: true)
            column(name: 'detail_licensee_class_id', value: 55)
            column(name: 'baseline_created_by_user', value: 'user@copyright.com')
            column(name: 'baseline_created_datetime', value: '2020-06-15 12:00:00+00')
            column(name: 'created_by_user', value: 'user@copyright.com')
            column(name: 'created_datetime', value: '2021-02-14 12:00:00+00')
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_udm_usage_batch') {
            column(name: 'df_udm_usage_batch_uid', value: 'f35461c9-a686-4046-a1f0-30b5f5654cc1')
            column(name: 'name', value: 'UDM Batch 2020 June 2')
            column(name: 'period', value: 202006)
            column(name: 'usage_origin', value: 'RFA')
            column(name: 'channel', value: 'Rightsdirect')
        }
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_udm_usage') {
            column(name: 'df_udm_usage_uid', value: '246837af-498e-48aa-b974-707df0285854')
            column(name: 'df_udm_usage_batch_uid', value: 'f35461c9-a686-4046-a1f0-30b5f5654cc1')
            column(name: 'original_detail_id', value: 'OGN674GHHSB007123')
            column(name: 'period', value: 202006)
            column(name: 'period_end_date', value: '2020-06-30')
            column(name: 'status_ind', value: 'ELIGIBLE')
            column(name: 'rh_account_number', value: 1000002859)
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_udm_usage') {
            column(name: 'df_udm_usage_uid', value: '0f6466e6-b4f8-460a-814e-841bbebe212b')
            column(name: 'df_udm_usage_batch_uid', value: 'f35461c9-a686-4046-a1f0-30b5f5654cc1')
            column(name: 'original_detail_id', value: 'OGN674GHHSB013312313')
            column(name: 'period', value: 202006)
            column(name: 'period_end_date', value: '2020-06-30')
            column(name: 'status_ind', value: 'ELIGIBLE')
            column(name: 'assignee', value: 'wjohn@copyright.com')
