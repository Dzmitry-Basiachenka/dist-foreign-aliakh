databaseChangeLog {
    ...
    changeSet(id: '2022-11-03-00', author: 'Anton Azarenka <azarenka@copyright.com>') {
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_acl_scenario_detail_archived') {
            column(name: 'df_acl_scenario_detail_archived_uid', value: '3f5c6098-e026-46a5-a279-a72a3c958783')
            column(name: 'df_acl_scenario_uid', value: 'd18d7cab-8a69-4b60-af5a-0a0c99b8a4d3')
            column(name: 'period_end_date', value: 202012)
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_acl_scenario_detail_archived') {
            column(name: 'df_acl_scenario_detail_archived_uid', value: '2305195c-83c4-4ff9-9e91-6c230dbf4230')
            column(name: 'df_acl_scenario_uid', value: 'd18d7cab-8a69-4b60-af5a-0a0c99b8a4d3')
            column(name: 'period_end_date', value: 202012)
            column(name: 'original_detail_id', value: 'OGN674GHHSB107')
            column(name: 'wr_wrk_inst', value: 122813964)
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_acl_share_detail_archived') {
            column(name: 'df_acl_share_detail_archived_uid', value: '1bcdcc38-ee66-491b-9e1a-4545ce7be8b5')
            column(name: 'df_acl_scenario_uid', value: 'd18d7cab-8a69-4b60-af5a-0a0c99b8a4d3')
            column(name: 'df_acl_scenario_detail_archived_uid', value: '3f5c6098-e026-46a5-a279-a72a3c958783')
        ...
        insert(schemaName: dbAppsSchema, tableName: 'df_acl_share_detail_archived') {
            column(name: 'df_acl_share_detail_archived_uid', value: 'ec0223ee-b125-457c-8474-b0acddbd8858')
            column(name: 'df_acl_scenario_uid', value: 'd18d7cab-8a69-4b60-af5a-0a0c99b8a4d3')
            column(name: 'df_acl_scenario_detail_archived_uid', value: '2305195c-83c4-4ff9-9e91-6c230dbf4230')
