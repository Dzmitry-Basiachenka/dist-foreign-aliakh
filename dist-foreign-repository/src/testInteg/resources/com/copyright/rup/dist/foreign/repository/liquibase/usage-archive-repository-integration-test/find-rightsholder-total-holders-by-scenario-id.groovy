databaseChangeLog {
    ...
    changeSet(id: '2017-11-30-00', author: 'Aliaksandra_Bayanouskaya <abayanouskaya@copyright.com>') {
        comment('Inserting test data for testFindRightsholderTotalsHoldersByScenarioIdEmptySearchValue, testFindRightsholderTotalsHoldersByScenarioIdNotEmptySearchValue, ' +
                'testFindRightsholderTotalsHoldersByScenarioIdSortByAccountNumber, testFindRightsholderTotalsHoldersByScenarioIdSortByName, ' +
                'testFindRightsholderTotalsHolderCountByScenarioId')
