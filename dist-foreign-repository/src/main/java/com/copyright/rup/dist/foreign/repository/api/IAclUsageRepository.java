...
public interface IAclUsageRepository {
     ...
     */
    List<String> populateAclUsages(String usageBatchId, Set<Integer> periods, String userName, Set<Long> wrWrkInsts);
    ...
    /**
     * Finds count of invalid ACL usages (publication type or content unit price is null).
