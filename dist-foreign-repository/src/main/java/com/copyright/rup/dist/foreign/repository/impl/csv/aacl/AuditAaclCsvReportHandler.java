...
public class AuditAaclCsvReportHandler extends BaseCsvReportHandler<UsageDto> {
    ...
    private static final List<String> HEADERS =
        Arrays.asList("Detail ID", "Baseline ID", "Detail Status", "Product Family", "Usage Batch Name",
    ...
    protected List<String> getBeanProperties(UsageDto bean) {
        ...
        beanProperties.add(getBeanPropertyAsString(bean.getAaclUsage().getDetailLicenseeClassId()));
