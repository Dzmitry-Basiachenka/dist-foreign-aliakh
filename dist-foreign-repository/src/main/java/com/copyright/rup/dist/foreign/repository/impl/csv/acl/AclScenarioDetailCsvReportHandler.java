...
public class AclScenarioDetailCsvReportHandler extends BaseCsvReportHandler<AclScenarioDetailDto> {
    ...
    private static final List<String> HEADERS = Arrays.asList("Detail ID", "Usage Detail ID", "Product Family",
        ...
        "Pub Type Weight", "Price", "Price Flag", "Content", "Content Flag", "Content Unit Price",
        "Content Unit Price Flag", "Print Value Share", "Print Volume Share", "Print Detail Share",
        "Print Net Amt in USD", "Digital Value Share", "Digital Volume Share", "Digital Detail Share",
        "Digital Net Amt in USD", "Combined Net Amt in USD");
