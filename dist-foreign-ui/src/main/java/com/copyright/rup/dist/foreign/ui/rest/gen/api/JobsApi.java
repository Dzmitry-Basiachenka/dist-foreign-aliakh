...
@Api(value = "Jobs", description = "the Jobs API")
    public interface JobsApi {
            ...
            @ApiOperation(value = "Gets status of the job", nickname = "getJobStatus", notes = "", response = JobStatus.class, tags={ "jobs", })
            @ApiResponses(value = { 
        ...
        default ResponseEntity<JobStatus
> getJobStatus(
 @PathVariable("jobName") String jobName
            ...
            @ApiOperation(value = "Triggers the job", nickname = "triggerJob", notes = "", response = JobStatus.class, tags={ "jobs", })
            @ApiResponses(value = { 
