...
/**
 * Represents common class for UDM filter windows.
 ...
 */
public class UdmCommonFilterWindow<T> extends CommonFilterWindow<T> {
     ...
     */
    @SafeVarargs
    public UdmCommonFilterWindow(String caption, IFilterWindowController<T> controller,
