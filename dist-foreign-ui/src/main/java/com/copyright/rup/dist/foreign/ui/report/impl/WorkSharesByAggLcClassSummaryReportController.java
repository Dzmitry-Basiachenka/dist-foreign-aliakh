...
public class WorkSharesByAggLcClassSummaryReportController extends CommonController<ICommonScenarioReportWidget>
    ...
    private static final long serialVersionUID = -5730646058674192467L;
    ...
    public IStreamSource getCsvStreamSource() {
        return streamSourceHandler.getCsvStreamSource(
            () -> String.format("work_shares_by_agg_lc_class_summary_report_%s_", getWidget().getScenario().getName()),
            pos -> reportService.writeWorkSharesByAggLcClassSummaryCsvReport(getWidget().getScenario(), pos));
    }
