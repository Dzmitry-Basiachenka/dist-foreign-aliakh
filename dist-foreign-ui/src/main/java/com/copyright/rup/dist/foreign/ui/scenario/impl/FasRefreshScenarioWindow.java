 ...
 * @author Ihar Suvorau
 */
// TODO {srudak} remove when  migration to new UI classes is finished; adjust original RefreshScenarioWindow
public class FasRefreshScenarioWindow extends Window {
     ...
     */
    public FasRefreshScenarioWindow(FetchCallback<UsageDto, Void> fetchCallback,
