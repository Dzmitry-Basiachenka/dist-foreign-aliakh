...
@Api(value = "StatisticUsage", description = "the StatisticUsage API")
    public interface StatisticUsageApi {
            ...
            @ApiOperation(value = "Gets usage statistic", nickname = "getUsageStatistic", notes = "", response = UsageStat.class, tags={ "statistic, usage", })
            @ApiResponses(value = { 
        ...
        default ResponseEntity<UsageStat
> getUsageStatistic(
 @PathVariable("usageId") String usageId
