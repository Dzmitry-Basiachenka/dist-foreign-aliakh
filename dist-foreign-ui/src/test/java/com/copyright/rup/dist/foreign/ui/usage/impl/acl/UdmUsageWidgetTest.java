    ...
    private void verifyGrid(Grid grid) {
        ...
        assertEquals(
            Arrays.asList("Detail ID", "Period", "Usage Origin", "Usage Detail ID", "Detail Status", "Reported Title",
                "System Title", "Wr Wrk Inst", "Reported Standard Number", "Standard Number", "Reported Pub Type",
                "Publication Format", "Article", "Language", "Det LC ID", "Det LC Name", "Company ID", "Company Name",
                "Survey Respondent", "IP Address", "Survey Country", "Channel", "Usage Date", "Survey Start Date",
