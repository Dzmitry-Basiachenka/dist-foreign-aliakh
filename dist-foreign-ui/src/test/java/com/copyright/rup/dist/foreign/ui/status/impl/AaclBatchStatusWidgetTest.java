 ...
 */
public class AaclBatchStatusWidgetTest {

    private AaclBatchStatusWidget batchStatusWidget;
    private ICommonBatchStatusController controller;

    @Before
    public void setUp() {
        controller = createMock(ICommonBatchStatusController.class);
        batchStatusWidget = new AaclBatchStatusWidget();
    ...
    public void testComponentStructure() {
        ...
        UiTestHelper.verifyGrid(grid, Arrays.asList(
            ...
            Triple.of("Sent For Classification", 170.0, -1),
