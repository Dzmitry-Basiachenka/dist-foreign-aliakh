...
public class AaclAuditAppliedFilterWidgetTest {
    ...
    private void verifyLayout() {
        ...
        verifyLabel(((VerticalLayout) component).getComponent(3), "Usage Period", String.valueOf(USAGE_PERIOD));
        verifyLabel(((VerticalLayout) component).getComponent(4), "Event ID", EVENT_ID);
        verifyLabel(((VerticalLayout) component).getComponent(5), "Dist. Name", DISTRIBUTION_NAME);
    }
