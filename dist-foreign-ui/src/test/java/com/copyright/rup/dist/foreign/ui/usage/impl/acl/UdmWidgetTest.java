...
public class UdmWidgetTest {
    ...
    public void testWidgetStructure() {
        ...
        replay(controller, udmUsageController, udmUsageWidget, udmValueController, udmValueWidget);
        UdmWidget widget = new UdmWidget();
        widget.setController(controller);
        widget.init();
        verify(controller, udmUsageController, udmUsageWidget, udmValueController, udmValueWidget);
