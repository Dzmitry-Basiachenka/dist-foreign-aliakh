...
/**
 * Verifies {@link SalRejectScenariosWindow}.
 * <p>
 ...
 */
public class SalRejectScenariosWindowTest {

    private static final String SCENARIO_ID_1 = "97b59d63-060c-4d9a-8cbe-e54cc1d83765";
    ...
    public void setUp() {
        ...
        controller.handleAction(ScenarioActionTypeEnum.REJECTED, Set.of(scenario1, scenario2));
        expectLastCall().once();
        replay(controller);
        window = new SalRejectScenariosWindow(controller);
    ...
    public void testComponentStructure() {
        ...
        assertEquals("Choose Scenarios to Reject", window.getCaption());
    ...
    private void verifyButtonsLayout(HorizontalLayout buttonsLayout) {
        ...
        assertEquals("Reject", submitButton.getCaption());
        assertFalse(submitButton.isEnabled());
